...
- **Collapse repeated entries.** While a single file is loaded, consecutive repeats are folded into one line with a repeat count, and a checkbox turns that off. Clicking a collapsed group's header expands or restores it right there in the panel.
